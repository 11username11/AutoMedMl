...
const NotFound = () => {
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-background via-background to-primary/5 flex items-center justify-center">
      <div 
      ...
      <div className={`relative z-10 text-center space-y-8 px-6 max-w-2xl mx-auto transition-all duration-1000 transform animate-fade-in`}>
